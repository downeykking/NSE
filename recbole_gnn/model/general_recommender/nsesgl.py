...
class NSESGL(GeneralGraphRecommender):
    ...
    def __init__(self, config, dataset):
        super(NSESGL, self).__init__(config, dataset)
    ...
    def random_graph_augment(self):
        ...
        edge_index, edge_weight = gcn_norm(edge_index, num_nodes=self.n_users + self.n_items, add_self_loops=False)
    ...
    def calc_bpr_loss(self, user_emd, item_emd, user_list, pos_item_list, neg_item_list):
        ...
        l1 = self.bpr_loss(p_scores, n_scores)
    ...
    def calc_ssl_loss(self, user_list, pos_item_list, user_sub1, user_sub2, item_sub1, item_sub2):
        ...
        return (ssl_item + ssl_user) * self.ssl_weight / len(user_list)
