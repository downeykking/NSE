...
class NSENGCF(GeneralGraphRecommender):
    ...
    def __init__(self, config, dataset):
        super(NSENGCF, self).__init__(config, dataset)
        ...
        self.sp_adj = self.get_neighbor_adj()
        ...
        self.sp_adj = self.sp_adj.to(self.device)
    ...
    def calculate_loss(self, interaction):
        ...
        reg_loss = self.reg_loss(u_embeddings, pos_embeddings, neg_embeddings,
                                 require_pow=True)  # L2 regularization of embeddings
