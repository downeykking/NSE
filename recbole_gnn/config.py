...
class Config(RecBole_Config):
    ...
    def _load_internal_config_dict(self, model, model_class, dataset):
        ...
        if os.path.isfile(model_init_file):
            ...
            # used for dataset setting
            config_dict = self._update_internal_config_dict(dataset_init_file)
            # used for overall setting
            config_dict = self._update_internal_config_dict(overall_init_file)
